...
bool onstepAux::sendCommand(const char *cmd, char *resp)
{
...
bool onstepAux::getActiveChannels()
{
...
bool onstepAux::setChannelOffset(unsigned int channel, float value)
{
    char cmd[MDCP_CMD_LENGTH] = {};
...
bool onstepAux::setAmbientOffset(float value)
{
    char cmd[MDCP_CMD_LENGTH] = {};
...
bool onstepAux::setChannelBoost( unsigned int channel, unsigned int value)
{
    char cmd[MDCP_CMD_LENGTH] = {};
...
bool onstepAux::setTrackingMode(unsigned int value)
{
    char cmd[MDCP_CMD_LENGTH] = {};
...
bool onstepAux::setCh3Mode(unsigned int value)
{
    char cmd[MDCP_CMD_LENGTH] = {};
...
bool onstepAux::setCh3Output(unsigned int value)
{
    char cmd[MDCP_CMD_LENGTH] = {};
...
// Set Tracking Offset
bool onstepAux::setTrackingOffset(int value)
{
    char cmd[MDCP_CMD_LENGTH] = {};
